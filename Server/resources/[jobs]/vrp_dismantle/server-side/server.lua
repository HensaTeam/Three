...
-----------------------------------------------------------------------------------------------------------------------------------------
cRP = {}
Tunnel.bindInterface("vrp_dismantle",cRP)
	...
	if user_id then
		if timeList > 0 and userList[user_id] then
			...
			if vehListNames ~= "" then
				TriggerClientEvent("Notify",source,"importante",vehListNames.." a lista é atualizada em <b>"..parseInt(timeList).." minutos</b>, cada veículo entregue o mesmo é removido da lista.",10000)
			else
