...
AddEventHandler("setPlateEveryone",function(plate)
	trydoors[plate] = true
	TriggerClientEvent("vrp_garages:syncTrydoors",-1,trydoors)
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- SETPLATEEVERYONE
-----------------------------------------------------------------------------------------------------------------------------------------
...
AddEventHandler("vRP:playerSpawn",function(user_id,source)
	TriggerClientEvent("vrp_garages:syncTrydoors",source,trydoors)
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- GARAGES
-----------------------------------------------------------------------------------------------------------------------------------------
local garages = {
	[1] = { ["name"] = "Garage", ["payment"] = false, ["public"] = true },
	[2] = { ["name"] = "Garage", ["payment"] = false, ["public"] = true },
	[3] = { ["name"] = "Garage", ["payment"] = false, ["public"] = true },
	[4] = { ["name"] = "Garage", ["payment"] = false, ["public"] = true },
	[5] = { ["name"] = "Garage", ["payment"] = false, ["public"] = true },
	[6] = { ["name"] = "Garage", ["payment"] = false, ["public"] = true },
	[7] = { ["name"] = "Garage", ["payment"] = false, ["public"] = true },
	[8] = { ["name"] = "Garage", ["payment"] = false, ["public"] = true },
	[9] = { ["name"] = "Garage", ["payment"] = false, ["public"] = true },
	[10] = { ["name"] = "Garage", ["payment"] = false, ["public"] = true },
	[11] = { ["name"] = "Garage", ["payment"] = false, ["public"] = true },
	[12] = { ["name"] = "Garage", ["payment"] = false, ["public"] = true },
	[13] = { ["name"] = "Garage", ["payment"] = false, ["public"] = true },
	[14] = { ["name"] = "Garage", ["payment"] = false, ["public"] = true },
	[15] = { ["name"] = "Garage", ["payment"] = false, ["public"] = true },
	[16] = { ["name"] = "Garage", ["payment"] = false, ["public"] = true },
	--[17] = { ["name"] = "Garage", ["payment"] = false, ["public"] = true },
	[18] = { ["name"] = "Garage", ["payment"] = false, ["public"] = true },
	[19] = { ["name"] = "Paramedic", ["payment"] = false, ["perm"] = "Paramedic" },
	[20] = { ["name"] = "Heliparamedic", ["payment"] = false, ["perm"] = "Paramedic" },
	[21] = { ["name"] = "Police", ["payment"] = false, ["perm"] = "Police" },
	[22] = { ["name"] = "Police", ["payment"] = false, ["perm"] = "Police" },
	[23] = { ["name"] = "Police", ["payment"] = false, ["perm"] = "Police" },
	[759] = { ["name"] = "Police", ["payment"] = false, ["perm"] = "Police" },
	[24] = { ["name"] = "Helipolice", ["payment"] = false, ["perm"] = "Police" },
	[25] = { ["name"] = "Helipolice", ["payment"] = false, ["perm"] = "Police" },
	[26] = { ["name"] = "Helipolice", ["payment"] = false, ["perm"] = "Police" },
	[27] = { ["name"] = "Driver", ["payment"] = false, ["public"] = true },
	[28] = { ["name"] = "Boats", ["payment"] = false, ["public"] = true },
	[29] = { ["name"] = "Boats", ["payment"] = false, ["public"] = true },
	[30] = { ["name"] = "Boats", ["payment"] = false, ["public"] = true },
	[31] = { ["name"] = "Benefactor", ["payment"] = false, ["public"] = true },
	[32] = { ["name"] = "Transporter", ["payment"] = false, ["public"] = true },
	[33] = { ["name"] = "Lumberman", ["payment"] = false, ["public"] = true },
	[34] = { ["name"] = "Fisherman", ["payment"] = false, ["public"] = true },
	[35] = { ["name"] = "Boats", ["payment"] = false, ["public"] = true },
	[36] = { ["name"] = "Garbageman", ["payment"] = false, ["public"] = true },
	[37] = { ["name"] = "Garage", ["payment"] = false, ["public"] = true },
	[38] = { ["name"] = "Prison", ["payment"] = false, ["perm"] = "Police" },
	[39] = { ["name"] = "Tacos", ["payment"] = false, ["public"] = true },
	[40] = { ["name"] = "Tow", ["payment"] = false, ["public"] = true },
	[41] = { ["name"] = "Tow", ["payment"] = false, ["public"] = true },
	[42] = { ["name"] = "Taxi", ["payment"] = false, ["public"] = true },
	-- [43] = { ["name"] = "TheLost", ["payment"] = false, ["perm"] = "TheLost" },
	[44] = { ["name"] = "PostOp", ["payment"] = false, ["public"] = true },
	[45] = { ["name"] = "Garage", ["payment"] = false, ["public"] = true },
	[46] = { ["name"] = "Ilegal", ["payment"] = false, ["public"] = true },
    ...
    [759] = { ["name"] = "Mecanica", ["payment"] = false, ["perm"] = false },
    [760] = { ["name"] = "Motoclub", ["payment"] = false, ["public"] = true },
    [761] = { ["name"] = "Caminhoneiro", ["payment"] = false, ["public"] = true },
    [762] = { ["name"] = "tesouro", ["payment"] = false, ["public"] = true },
    [763] = { ["name"] = "Lumberman", ["payment"] = false, ["public"] = true },
    [764] = { ["name"] = "Aeroporto", ["payment"] = false, ["public"] = true }
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- GARAGES
-----------------------------------------------------------------------------------------------------------------------------------------
	...
	if user_id and name then
		if not vCLIENT.returnVehicle(source,name) then
			...
			if vehicle[1] == nil then
				vRP.Query("vRP/add_vehicle",{ user_id = parseInt(user_id), vehicle = name, plate = vRP.generatePlateNumber(), phone = vRP.getPhone(user_id), work = tostring(true) })
			...
			if parseInt(os.time()) <= parseInt(vehicle[1].time+24*60*60) then
				...
				if status then
					if vRP.paymentBank(user_id,parseInt(vRP.vehiclePrice(name)*0.5)) then
						vRP.Query("vRP/set_arrest",{ user_id = parseInt(user_id), vehicle = name, arrest = 0, time = 0 })
					else
			...
			elseif vRP.vehicleType(tostring(name)) == "donate" and vRP.getCarPremium(name,user_id)then
				...
				if status then
					if vRP.remGmsId(user_id,parseInt(vRP.vehiclePrice(name))) then
						vRP.Query("vRP/set_rental_time",{ user_id = parseInt(user_id), vehicle = name, premiumtime = parseInt(os.time()) })
					else
				...
				if vehicle[1].plate == nil then
					...
					vRP.Query("vRP/update_plate_vehicle",{ user_id = parseInt(user_id), vehicle = name, plate = vehicle[1].plate })
				end
	...
	if user_id then
		...
		if vehicle and vehPlate then
			...
			if user_id == plateUserId or stealVehs[vehPlate] == user_id then
				TriggerClientEvent("vrp_garages:vehicleClientLock",-1,vehNet,vehLock)
...
function cnVRP.tryDelete(vehid,vehengine,vehbody,vehfuel,vehDoors,vehWindows,vehTyres,vehPlate)
	...
	TriggerClientEvent("vrp_garages:syncVehicle",-1,vehid,vehPlate)
end
-----------------------------------------------------------------------------------------------------------------------------------------
-- VRP_GARAGES:DELETEVEHICLE
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterServerEvent("vrp_garages:DeleteVehicle")
AddEventHandler("vrp_garages:DeleteVehicle",function(vehid,vehPlate)
	TriggerClientEvent("vrp_garages:syncVehicle",-1,vehid,vehPlate)
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- RETURNHOUSES
			...
			if myvehicles[1] then
				...
				if vRP.getPremium(parseInt(args[3])) then
					if parseInt(maxVehs[1].qtd) >= parseInt(myGarages[1].garage) + 2 then
						TriggerClientEvent("Notify",source,"importante","Você atingiu o número máximo de veículos na garagem.",5000)
						return
					end
				else
				...
				if vRP.request(source,"Deseja transferir o veículo <b>"..vRP.vehicleName(tostring(args[2])).."</b> para <b>"..identity.name.."</b>?",30) then
					...
					if vehicle[1] then
						...
						vRP.Query("vRP/move_vehicle",{ user_id = parseInt(user_id), nuser_id = parseInt(args[3]), vehicle = tostring(args[2]) })
						...
						if custom and custom2 ~= nil then
							...
							vRP.Query("vRP/rem_srv_data",{ dkey = "custom:"..parseInt(user_id)..":"..tostring(args[2]) })
						end
						...
						if chest and chest2 ~= nil then
							...
							vRP.Query("vRP/rem_srv_data",{ dkey = "chest:"..parseInt(user_id)..":"..tostring(args[2]) })
						end
